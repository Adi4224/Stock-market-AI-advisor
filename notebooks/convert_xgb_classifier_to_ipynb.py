...
def convert_py_to_ipynb(py_path, ipynb_path):
    ...
    nb = {
        ...
        'nbformat_minor': 0,
        'metadata': {
            'colab': {'provenance': [], 'name': '04_train_xgb_classifier.ipynb'},
    ...
    print(f"Created {ipynb_path} with {len(nb['cells'])} cells.")

if __name__ == '__main__':
    convert_py_to_ipynb('notebooks/04_train_xgb_classifier.py', 'notebooks/04_train_xgb_classifier.ipynb')
