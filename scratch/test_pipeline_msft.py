"""
Verification script for stock price prediction pipeline with another ticker.
"""
...
def test_predictions():
    print("=" * 60)
    print("TESTING STOCK PREDICTIONS FOR MSFT")
    print("=" * 60)
    ...
    for model in ["random_forest", "xgboost", "svm"]:
        ...
        price_res = predict_stock_price("MSFT", model)
        ...
        move_res = predict_stock_movement("MSFT", model)
